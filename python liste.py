...
#NAMEN DER SPIELER
for x in spieler:
    spieler[x-1]=input("Wie soll Spieler heißen:")
...
try:
    print("Spiel beginnt:",spieler[beginsp-1],"muss starten")
except:
...
for n in ttt:
    ...
    # input("Wähle die gewünschte Stelle mithilfe der Zahlen, die noch verfügbar sind")
"""
